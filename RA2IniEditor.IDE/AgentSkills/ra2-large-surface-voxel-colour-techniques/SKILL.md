...
- Use only after the Host supplies a human-confirmed LargeSurface class, active palette facts, semantic requirements, and
  one manually selected opaque non-remap BodyBase.
